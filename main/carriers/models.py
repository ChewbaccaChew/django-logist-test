...
class Vehicle(models.Model):
    ...
    vehicle_model = models.CharField(max_length=100, null=True, verbose_name='Модель ТС')
    ...
    wheel_formula = models.ForeignKey(WheelFormula, null=True, verbose_name='Колесная формула', on_delete=models.SET_NULL)
    vehicle_colour = models.ForeignKey(VehicleColour, null=True, verbose_name='Цвет ТС', on_delete=models.SET_NULL)
    vehicle_type = models.ForeignKey(VehicleType, null=True, verbose_name='Тип ТС', on_delete=models.SET_NULL)
    ...
    trailer_brand = models.ForeignKey(TrailerBrand, null=True, verbose_name='Марка прицепа', on_delete=models.SET_NULL)
    trailer_type = models.ForeignKey(TrailerType, null=True, verbose_name='Тип прицепа', on_delete=models.SET_NULL)
...
class Carrier(models.Model):
    ...
    email_cp = models.EmailField(verbose_name='Email')
